...
class BigsightContactusSection1 extends Component {
    ...
    render() {
        return (
            <div id="BigSight-ContactUs-Section1">
                <div className="row BigSight-ContactUs-Section1-Content-Container">
                    ...
                    <div className="col-7" data-aos="fade-up" data-aos-offset="200" data-aos-delay="500">
                        <form action="" className="BigSight-ContactUs-Section1-Form-Container" onSubmit={this.sendEmail}>
